...
NK_API void nk_glfw3_render(struct nk_glfw *glfw, enum nk_anti_aliasing,
...
NK_INTERN void nk_glfw3_device_upload_atlas(struct nk_glfw *glfw,
...
NK_API void nk_glfw3_font_stash_end(struct nk_glfw *glfw) {
  ...
  nk_font_atlas_end(&glfw->atlas, nk_handle_id((int)glfw->ogl.font_tex),
                    &glfw->ogl.tex_null);
